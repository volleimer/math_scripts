...
\begin{aus}[Notwendige Optimalitätsbedingung]
...
%% $a_i \in \real^n$, $a_i^T =$ $i$-te Zeile von $A$, $I = \{1, \ldots, m\}$.
\begin{flg} %2.6
...
\subsection{Lemma von Farkas}
\begin{lem}[Farkas] %2.8
