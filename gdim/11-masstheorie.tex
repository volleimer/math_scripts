...
Sei $X$ eine nichtleere Menge. Eine Funktion $\mu\colon2^X \to [0,\infty]$ heißt \emph{äußeres Maß} auf $X$ $:\Leftrightarrow$
\begin{enumerate}
 \item $\mu(\emptyset) = 0$.
...
Insbesondere für $T \in SO(n)$ ($\Rightarrow$ $\det T = 1$) ist $\lebesgue^n$ ist rotationsinvariant.
